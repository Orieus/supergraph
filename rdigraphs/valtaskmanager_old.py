...
class ValTaskManager(SgTaskManager):
    ...
    def get_ref_graphs(self, db):
        ...
        corpus_label = {'Co': 'Crunch4Ever', 'Pu': 'RG'}[db]
    ...
    def validate_topic_models(self, corpus, ref_graph=None):
        ...
        path2nodenames = (f'/Users/jcid/papergraphs_lab/source/models/'
                          f'metadata_models.csv')
        path2models = '/Users/jcid/papergraphs_lab/source/models'
